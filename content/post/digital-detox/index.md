...
Ma su di me hanno avuto un effetto benefico oltre ogni mia aspettativa: uso i social una frazione del tempo rispetto a prima, ho ricominciato a leggere libri, scrivo di più, leggo più contenuti di valore online invece di guardare puttanate inutili.



## Notifiche
Questa è la più banale di tutte, ma la metto per prima perché l'impatto è davvero sottovalutato: prendi il telefono e **disattiva le notifiche** di quasi tutto - news, email, gruppi Whatsapp, gruppi Teams, browser, videogames, e soprattutto di tutti i social.  
...
Conserva attive le notifiche di chiamate, SMS, Whatsapp, Telegram, Messenger e simili, cioè quello che serve per interagire con le **persone** reali, e conserva anche quelle dei **servizi critici** che richiedono la tua attenzione immediata (es. calendario, antifurto, pagamenti).  

Il costo di questa piccola scelta è praticamente zero, perché basta tener premuta la prossima notifica molesta col dito e selezionare "Disattiva" o "Silenzia", ci metti a farla grande 3 secondi per ciascuna app, ma il vantaggio di non avere più interruzioni inutili costanti (o un elenco di 35 notifiche inutili in mezzo alle quali affogano quelle utili) non ha prezzo.
...
Quindi: **disattiva le notifiche per le nuove email**. Semplice. Le nuove email le controlli ogni 1 2 4 8 ore, decidi tu in base al tipo di lavoro che fai.  

La cosa completamente sana sarebbe tenere Outlook iconizzato/nascosto, e aprirlo solo quando hai bisogno di usarlo; ma non puoi spegnerlo del tutto perché se usi il Calendario ti servono le notifiche degli eventi, e quelle funzionano solo se Outlook è aperto.  
...
## Notifiche Teams
Non bastasse il fastidio delle email, nel mondo business si è normalizzato l'abuso delle chat, che in quanto tali portano con sé le maledette notifiche.  
Inoltre, spesso le aziende _impongono_ la presenza dei dipendenti su Teams in quanto strumento aziendale condiviso e ufficiale per la comunicazione.  
Quindi non scappi, ti devi cuccare la tua dose di distrazione e stress per policy.  

A questo si sommano alcuni clienti che, siccome hai scambiato due chat durante una attività, da lì in avanti si sentono autorizzati a scriverti su Teams quando meglio credono.
...
* Quando un contatto scrive in occasioni "non concordate", **non rispondo**: dopo max un paio di interazioni mancate il problema di solito è risolto per sempre, e in caso vale sempre "scusami ma non guardo Teams, va benissimo se apri un ticket, o se hai bisogno di me scrivimi pure una email che appena riesco ti rispondo".



## Disinstalla le app dei social
Se hai una o più app tra Facebook, Instagram, Threads, TikTok, sia su PC che su smartphone, semplicemente disinstallale, ci metti 10 secondi per ciascuna.   
**Puoi accedere ai social usando il browser**, con questi vantaggi:
1. Meno risorse impegnate (le app consumano spazio e banda anche mentre non le usi attivamente)
1. Zero notifiche (non avrai mica attivato le notifiche del browser spero?!)
1. Più privacy (le app raccolgono dati di profilazione anche quando non le usi)
...
Imposta i tuoi dispositivi in modo che, un'ora prima di quando mediamente vai a dormire la sera, attivino automaticamente 2 opzioni:
1. **"Non disturbare"** per tagliare le notifiche inutili, configurandola in modo che i contatti della tua rubrica (o almeno i tuoi familiari) possano comunque chiamarti per le urgenze, e che le notifiche critiche (es. quelle dell'antifurto) funzionino ugualmente.
2. **"Modalità riposo"** o qualunque nome abbia nel tuo dispositivo, è quella che rende lo schermo tutto in bianco e nero: questo fa bene già di per sé secondo alcuni studi (tipo [questo](https://www.medicinalmedia.com/explore/set-your-phone-to-grayscale)), e inoltre ti serve come "promemoria gentile" che è ora di mettere giù il telefono perché tra un'ora andrai a dormire, e ci sono studi (tipo [questo](https://www.sciencedaily.com/releases/2014/12/141222131348.htm)) che parlano di questa come buona abitudine per migliorare la qualità del sonno.
...
Sto valutando l'acquisto di un **tablet Android da 7" con schermo e-ink a colori**, da usare in casa al posto del telefono e del mio attuale Kindle.  
...
* Ridurre l'uso dello smartphone durante la giornata, in particolare di tutte quelle micro-interazioni istintive che non servono a nulla
