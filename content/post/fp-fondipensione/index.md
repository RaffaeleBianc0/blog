...
La risorsa migliore che ho trovato online sul tema è [CiaoElsa.com](https://www.ciaoelsa.com/), un'azienda italiana che si occupa di previdenza complementare.

Del loro sito segnalo in particolare:

* [Blog e video](https://www.ciaoelsa.com/blog) divulgativi che ti spiegano tutto quello che c'è da sapere per fare una scelta sensata. Più sotto trovi il link ad alcuni tra i fondamentali.

* [Comparatore FP](https://www.ciaoelsa.com/comparatore), utile per scegliere un [fondo pensione aperto ("FPA")](https://www.ciaoelsa.com/schede-fondo/fondi-pensione-aperti/) da affiancare al [fondo pensione negoziale ("FPN")](https://www.ciaoelsa.com/schede-fondo/fondi-pensione-negoziali/) associato al settore di riferimento dell'azienda per cui lavori, se deciderai di avere [più fondi pensione](#più-fondi-pensione).
...
Se sei dipendente privato e guadagni più di 15.000 €/anno, allora versare il TFR più il tuo contributo volontario minimo nel FPN è ritenuta una **scelta _no-brainer_ che dovresti valutare al più presto**, prima di pensare a tutti gli altri temi della finanza personale.  
In [questo articolo su CiaoElsa.com](https://www.ciaoelsa.com/blog/meglio-tfr-in-azienda-o-tfr-nel-fondo-pensione) è spiegato bene, anche se le conclusioni sono espresse in modo molto più neutrale (_è una decisione personale_ e _dipende dalle tue esigenze_).

Se non l'hai già fatto, valuta di aprire _subito_ la tua posizione in un FP, perché **dopo i primi 15 anni di permanenza nella previdenza complementare le tasse che pagherai al riscatto della tua posizione cominciano a scendere dello 0,3% all’anno**: partono da un già basso 15% se avrai maturato 1-15 anni di contribuzione, per diventare 14,7% ai 16 anni di contribuzione, eccetera fino ad arrivare al 9% (la soglia minima) per 35 anni o più di contribuzione.  
Il confronto tra questa tassazione con quella applicata al tradizionale "TFR in azienda" è un altro buon motivo a netto favore del FP.
...
Ci sono almeno un paio di motivi che giustificano questa scelta.
...
Se preferisci la versione da leggere, ecco il post ["Come ritirare il fondo pensione al 100% in capitale: tutte le condizioni previste"](https://www.ciaoelsa.com/blog/ritirare-soldi-fondo-pensione-100-capitale) di CiaoElsa.
...
Per poter riscattare tutto il montante sottoforma di capitale al pensionamento c’è una **soglia** che il montante non deve superare, determinata da un calcolo che va fatto nell'anno del pensionamento, dato che dipende da un parametro variabile di anno in anno.  
Nel 2025 questa soglia è poco più di 100.000€.

**Fortunatamente questo calcolo va fatto _per ogni singolo FP_**, cioè non si fa considerando la _somma_ dei montanti se hai più FP: ecco che avere 50k in un fondo e 50k in un altro ti garantisce di rimanere in entrambi i FP sotto la soglia dei 100k, e di poter quindi decidere liberamente di ricevere l'intera prestazione in forma di capitale da ciascun FP, senza subìre obbligatoriamente i costi propri della rendita. 

Un altro motivo è il **profilo di investimento**: di norma gli FPN limitano la parte azionaria a circa il 60% sul comparto più aggressivo che propongono, ma se ti mancano più di 10 anni alla pensione magari ti interessa una percentuale azionaria più alta.  
Con questo obiettivo, potresti scegliere di tenere l'FPN solo perché è lì che ottieni il contributo del datore, e aderire ad un secondo FP (un FPA, Fondo Pensione Aperto) che sia poco costoso, nel quale versare solo contributi volontari tramite semplici bonifici, e che ti offra un profilo di investimento con una **quota azionaria maggiore**.  

La soglia dei famosi 5164€/anno per massimizzare la deduzione si raggiunge sommando i contributi volontari e datoriali su _tutti_ i fondi pensione che hai sottoscritto, quindi fai bene i conti se ne hai due o più.  
...
Taglio la testa al toro e ti dò subito la risposta verso cui convergono tanti divulgatori: la soluzione migliore _mediamente_ sembra essere quella di **sfruttare contributo datoriale e deduzioni dei FP fino al massimo annuo di 5164€, e investire eventuale ulteriori risparmi in ETF**.  
Facendo questo, oltre ai soldi che ti arrivano dal datore di lavoro, l'anno seguente avrai anche una deduzione in dichiarazione dei redditi: soldi in tasca che altrimenti non avresti.  
Le tasse su questi versamenti le pagherai al pensionamento, e saranno più basse (9-15%) rispetto a quelle che avresti pagato come IRPEF tenendo quei soldi "in tasca".
...
* **Più libertà:** Sei 100% libero di decidere la tua allocazione, e quando e quanto disinvestire, mentre il FP è per sua natura più vincolato.  
...
CiaoElsa ne parla in questi 2 articoli:
...
In sostanza, se hai figli potresti valutare di aprire un FP qualunque (magari quello con il costo annuo più basso) intestato a loro, così intanto maturano l’anzianità di cui sopra.  

**Esempio:**  
**2025**: tuo figlio ha 5 anni, apri la sua posizione in un FP.  
**2045**: tuo figlio ha 25 anni, inizia a lavorare come dipendente, e contestualmente ad alimentare il proprio FP.  
**2050**: tuo figlio ha 30 anni, e si mette in proprio, senza chiudere il FP (solo per dire che non è obbligatorio restare dipendenti a vita).  
**2060**: tuo figlio ha 40 anni, e ha già maturato l'anzianità di 35 anni nella previdenza complementare, che gli garantisce la tassazione minima al riscatto: cioè quando andrà in pensione pagherà solo il 9% di tasse sul capitale accumulato nel FP.
