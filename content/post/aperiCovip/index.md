...
Per scegliere un [fondo pensione]({{< ref "fp-fondipensione.md" >}}), specie un FPA, i parametri essenziali sono 2:
...
Questi parametri ufficiali sono pubblicati periodicamente sul sito COVIP, quindi dovresti:
- trovare dove sono questi dati
- scaricarli e aprirli, sono distribuiti in 2 file Excel separati e formattati diversamente
- mixare le informazioni che leggi sul file "costi" con quelle che leggi sul file "rendimenti"
...
Per facilitare la vita al prossimo, ho fatto **aperiCovip**, una piccola webapp che ti guida in 3 semplici passaggi a fare la stessa valutazione, ma con un risultato molto più fruibile e ottenuto con pochi click.  
